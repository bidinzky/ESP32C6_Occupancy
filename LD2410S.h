...
public:
    ...
    void register_listener(LD2410SListener* listener) { this->listener = listener; };
    void set_config_mode(bool enabled);
    void apply_config();
    void start_auto_threshold_update();

    void set_max_distance_number(int max_distance_number) { this->max_distance_number = max_distance_number; };
    void set_min_distance_number(int min_distance_number) { this->min_distance_number = min_distance_number; };
    void set_no_delay_number(int delay_number) { this->no_delay_number = delay_number; };
    void set_status_reporting_freq_number(int status_reporting_freq_number) { this->status_reporting_freq_number = status_reporting_freq_number; };
    void set_distance_reporting_freq_number(int distance_reporting_freq_number) { this->distance_reporting_freq_number = distance_reporting_freq_number; };
...
private:
    Stream* serial;
    LD2410SListener* listener;
    Config current_config;
    bool cmd_active{ false };
    int max_distance_number;
    int min_distance_number;
    int no_delay_number;
    int status_reporting_freq_number;
    int distance_reporting_freq_number;
#ifdef USE_BUTTON
